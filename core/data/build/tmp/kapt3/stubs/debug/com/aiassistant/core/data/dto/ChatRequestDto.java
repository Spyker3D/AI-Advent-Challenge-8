...
public final class ChatRequestDto {
    ...
    @org.jetbrains.annotations.NotNull()
    private final java.util.List<com.aiassistant.core.data.dto.MessageDto> messages = null;
    ...
    java.util.List<com.aiassistant.core.data.dto.MessageDto> messages, float temperature, int maxTokens) {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.aiassistant.core.data.dto.MessageDto> getMessages() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.aiassistant.core.data.dto.MessageDto> component2() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.aiassistant.core.data.dto.ChatRequestDto copy(@org.jetbrains.annotations.NotNull()
    java.lang.String model, @org.jetbrains.annotations.NotNull()
    java.util.List<com.aiassistant.core.data.dto.MessageDto> messages, float temperature, int maxTokens) {
        return null;
    }
